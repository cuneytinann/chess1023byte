...
const BUILDS = [
  { src: 'chess.js',   out: 'index.html',   head: '<center><table id=T><script>', crush: [0, 0, 0, 0] },
  { src: 'minimum.js', out: 'minimum.html', head: '<input id=p><table id=T><script>', crush: [1, 0, 1, 0] },
];
